...
| 依赖 | 版本 | 许可证 |
| --- | --- | --- |
| [SFML-ME](https://github.com/JasonLeon01/SFML-ME/releases/tag/310ME-iOSJoystick) | `310ME-iOSJoystick` 标签 | [zlib/libpng](https://opensource.org/licenses/Zlib) — 详见 `third_party/SFML/license.md` |
