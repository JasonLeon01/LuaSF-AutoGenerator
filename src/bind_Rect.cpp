...
void bind_Rect(sol::state_view lua)
{
    ...
    LUASF_STUB_FUNCTION("sf.IntRect", "new", "fun(x: integer, y: integer, width: integer, height: integer): sf.IntRect");
    ...
    LUASF_STUB_FUNCTION("sf.IntRect", "findIntersection", "fun(self: sf.IntRect, other: sf.IntRect): sf.IntRect|nil");

    LUASF_STUB_CLASS("sf.FloatRect");
    LUASF_STUB_FIELD("position", "sf.Vector2f");
    LUASF_STUB_FIELD("size", "sf.Vector2f");
    LUASF_STUB_FUNCTION("sf.FloatRect", "new", "fun(x: number, y: number, width: number, height: number): sf.FloatRect");
    ...
    LUASF_STUB_FUNCTION("sf.FloatRect", "findIntersection", "fun(self: sf.FloatRect, other: sf.FloatRect): sf.FloatRect|nil");
