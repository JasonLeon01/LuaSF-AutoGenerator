...
void bind_Event(sol::state_view lua)
{
    ...
    LUASF_STUB_FUNCTION("sf.Event_FocusGained", "new", "fun(): sf.Event_FocusGained");
    bind_empty_event_subtype<sf::Event::FocusGained>(sf, "Event_FocusGained");

    LUASF_STUB_CLASS("sf.Event_MouseEntered");
    LUASF_STUB_FUNCTION("sf.Event_MouseEntered", "new", "fun(): sf.Event_MouseEntered");
    ...
    LUASF_STUB_FUNCTION("sf.Event_TextEntered", "new", "fun(): sf.Event_TextEntered");
    ...
    LUASF_STUB_FUNCTION("sf.Event_KeyPressed", "new", "fun(): sf.Event_KeyPressed");
    ...
    LUASF_STUB_FIELD("shift", "boolean");
    LUASF_STUB_FIELD("system", "boolean");
    LUASF_STUB_FUNCTION("sf.Event_KeyReleased", "new", "fun(): sf.Event_KeyReleased");
    ...
    LUASF_STUB_FUNCTION("sf.Event_MouseWheelScrolled", "new", "fun(): sf.Event_MouseWheelScrolled");
    ...
    LUASF_STUB_FIELD("position", "sf.Vector2i");
    LUASF_STUB_FUNCTION("sf.Event_MouseButtonPressed", "new", "fun(): sf.Event_MouseButtonPressed");
    ...
    LUASF_STUB_FIELD("button", "sf.Mouse.Button");
    LUASF_STUB_FIELD("position", "sf.Vector2i");
    LUASF_STUB_FUNCTION("sf.Event_MouseButtonReleased", "new", "fun(): sf.Event_MouseButtonReleased");
    ...
    LUASF_STUB_FIELD("position", "sf.Vector2i");
    LUASF_STUB_FUNCTION("sf.Event_MouseMoved", "new", "fun(): sf.Event_MouseMoved");
    ...
    LUASF_STUB_FUNCTION("sf.Event_MouseMovedRaw", "new", "fun(): sf.Event_MouseMovedRaw");
    ...
    LUASF_STUB_FUNCTION("sf.Event_JoystickButtonPressed", "new", "fun(): sf.Event_JoystickButtonPressed");
    ...
    LUASF_STUB_FIELD("joystickId", "integer");
    LUASF_STUB_FIELD("button", "integer");
    LUASF_STUB_FUNCTION("sf.Event_JoystickButtonReleased", "new", "fun(): sf.Event_JoystickButtonReleased");
    ...
    LUASF_STUB_FUNCTION("sf.Event_JoystickMoved", "new", "fun(): sf.Event_JoystickMoved");
    ...
    LUASF_STUB_FIELD("joystickId", "integer");
    LUASF_STUB_FUNCTION("sf.Event_JoystickConnected", "new", "fun(): sf.Event_JoystickConnected");
    ...
    LUASF_STUB_FIELD("joystickId", "integer");
    LUASF_STUB_FUNCTION("sf.Event_JoystickDisconnected", "new", "fun(): sf.Event_JoystickDisconnected");
    ...
    LUASF_STUB_FIELD("position", "sf.Vector2i");
    LUASF_STUB_FUNCTION("sf.Event_TouchBegan", "new", "fun(): sf.Event_TouchBegan");
    ...
    LUASF_STUB_FIELD("finger", "integer");
    LUASF_STUB_FIELD("position", "sf.Vector2i");
    LUASF_STUB_FUNCTION("sf.Event_TouchMoved", "new", "fun(): sf.Event_TouchMoved");
    ...
    LUASF_STUB_FIELD("finger", "integer");
    LUASF_STUB_FIELD("position", "sf.Vector2i");
    LUASF_STUB_FUNCTION("sf.Event_TouchEnded", "new", "fun(): sf.Event_TouchEnded");
    ...
    LUASF_STUB_FUNCTION("sf.Event_SensorChanged", "new", "fun(): sf.Event_SensorChanged");
    ...
    LUASF_STUB_FUNCTION("sf.Event", "new", "fun(value: sf.Event_Closed): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_Resized): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_FocusLost): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_FocusGained): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_TextEntered): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_KeyPressed): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_KeyReleased): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_MouseWheelScrolled): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_MouseButtonPressed): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_MouseButtonReleased): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_MouseMoved): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_MouseMovedRaw): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_MouseEntered): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_MouseLeft): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_JoystickButtonPressed): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_JoystickButtonReleased): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_JoystickMoved): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_JoystickConnected): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_JoystickDisconnected): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_TouchBegan): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_TouchMoved): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_TouchEnded): sf.Event");
    LUASF_STUB_OVERLOAD("sf.Event", "new", "fun(value: sf.Event_SensorChanged): sf.Event");
    ...
    LUASF_STUB_FUNCTION("sf.Event", "getIfJoystickButtonReleased", "fun(self: sf.Event): sf.Event_JoystickButtonReleased|nil");
    ...
    LUASF_STUB_FUNCTION("sf.Event", "getIfJoystickMoved", "fun(self: sf.Event): sf.Event_JoystickMoved|nil");
    event.set_function("getIfJoystickMoved", [lua](sf::Event& self) { return event_get_if<sf::Event::JoystickMoved>(lua, self); });
    LUASF_STUB_FUNCTION("sf.Event", "getIfJoystickConnected", "fun(self: sf.Event): sf.Event_JoystickConnected|nil");
    event.set_function("getIfJoystickConnected", [lua](sf::Event& self) { return event_get_if<sf::Event::JoystickConnected>(lua, self); });
    LUASF_STUB_FUNCTION("sf.Event", "getIfJoystickDisconnected", "fun(self: sf.Event): sf.Event_JoystickDisconnected|nil");
    ...
    LUASF_STUB_FUNCTION("sf.Event", "getIfTouchBegan", "fun(self: sf.Event): sf.Event_TouchBegan|nil");
    event.set_function("getIfTouchBegan", [lua](sf::Event& self) { return event_get_if<sf::Event::TouchBegan>(lua, self); });
    LUASF_STUB_FUNCTION("sf.Event", "getIfTouchMoved", "fun(self: sf.Event): sf.Event_TouchMoved|nil");
    event.set_function("getIfTouchMoved", [lua](sf::Event& self) { return event_get_if<sf::Event::TouchMoved>(lua, self); });
    LUASF_STUB_FUNCTION("sf.Event", "getIfTouchEnded", "fun(self: sf.Event): sf.Event_TouchEnded|nil");
    event.set_function("getIfTouchEnded", [lua](sf::Event& self) { return event_get_if<sf::Event::TouchEnded>(lua, self); });
    LUASF_STUB_FUNCTION("sf.Event", "getIfSensorChanged", "fun(self: sf.Event): sf.Event_SensorChanged|nil");
